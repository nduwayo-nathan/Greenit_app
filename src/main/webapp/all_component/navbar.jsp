...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link active" href="#"> <i class="fa-solid fa-tree"></i>Trees</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link active" href="#"> <i class="fa-solid fa-seedling"></i> Seedlings</a>
      </li>
       <li class="nav-item">
          <a class="nav-link active" href="#"> <i class="fa-solid fa-fan"></i> Flowers</a>
       </li>
